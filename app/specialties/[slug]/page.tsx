    ...
    <div>
      <div className="border-b border-line bg-sky px-6 py-16">
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className="mt-6 text-section-header font-extrabold text-ink">
            {specialty}
          </h1>
          <p className="mt-3 max-w-2xl text-xl font-medium text-ink/70">
            {copy.tagline}
          </p>
        </div>
      </div>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16">
        <RevealGroup>
          <RevealItem>
            <p className="max-w-3xl text-lg font-medium leading-relaxed text-ink/70">
              {copy.description}
            </p>
          </RevealItem>
        </RevealGroup>
